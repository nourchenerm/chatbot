...
from helper.chatbot import chatbot_logic, load_qa, custom_spell_checker, extract_keywords_from_intents
from spellchecker import SpellChecker
from autocorrect import Speller
import secrets
from gestion.chatbot_client import load_qa, closest_tag, chatbot_logic
from gestion.action_facture import preprocess_text, add_facture, detect_information, ajouter_option, custom_spell_checker1
from gestion.extract_info import extract_clients_info, extract_contact_info, extract_article_info, extract_article_id, extract_total_amount, extract_prefixe,check_stock
from gestion.user_data import config, facture_data, payload, values_key
...
file_path1 = "helper/intents.json"
file_path = "gestion/tag.json"

# Load initial QA data from the JSON files
qa_data1 = load_qa(file_path1)
...
keywords_fr = extract_keywords_from_intents(qa_data1, 'fr')
keywords_en = extract_keywords_from_intents(qa_data1, 'en')
