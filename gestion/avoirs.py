...
from action_facture import preprocess_text, add_facture, detect_information, ajouter_option
...
from user_data import config, facture_data, facture_keywords,payload
...
def chatbot():
    ...
    if context == 'initial' and tag1 != 'confirmer' and tag1 != 'oui' and tag1 != 'non'  :
        ...
        prefixe = extract_prefixe("https://pp-unum-back.etcinfo.tech/api/societe/numerotations/generate-prefix?type=avoir",token="eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiJ9..bAIydF671CMJJXTWCi9VmNM5-LqQMb1Q-OrBmR40_6y-JQEZqqE6-EAlGnmwXzcVS9X53Qawht7c_mmzfjzSK_7_fqdBSo6gSXVDyc9OmnsJd1rAFPDXx0xF-dQ27vVITbEn3KTD8sJhPQbLXtN6kxY6w7B2S82r-M3jPONMg9pdJHq83sOZi28KLm68uShEHO36XhIWxaxJPRamLmHfDhJWh9BRXZCORXvMYMNAG-r-onRa8E6MfOaTpTUHQPGFcPdyk3KVp31IeTAt2HwGbdjG72j953OxVyGcx5ximBWogrjgM8V8vXKtDZN4FDb5_J3C8DKmFRTQwPBNA7aKhg")
        ...
        if detected_info:
                ...
                for article_code in codes : 
                        print(article_code)
                        article_id = extract_article_id( "https://pp-unum-back.etcinfo.tech/api/societe/articles",article_code, token="eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiJ9..N_QeyVcsIimQyF8WeXEkF5KOBBZs_f4Csa8ARPxpOCBX5kvswkyjAbSy5-MGSDTessZD4CvU71Jx8MThlRnQTYnwFEJgxA_sYg7nXYesiP_bwOFaIW0QpcDNKdJTnpl6w1hcY2ln8HP8zh5sFLm3GHhprmyLjELRh88ms9GHTX9vMD0iupzIBhos4NvwDNoyxKQeOGhyUFj_k5YsBHWiSbs3QPPE2D-eqJeT6UI0lfFKV6AifUXNlFXxYTxCyljht3rFWTRYLWc7UjtDkGz6ZR13T8LBGNeu9zQLhWMsslJWpkCgNajqXL9NntKpfjmI9dU1tTCI8mUd_KZUPOKDpg")
                        print("article_id",article_id)
                        ligne_article = extract_article_info("https://pp-unum-back.etcinfo.tech/api/societe/piece/article-details",article_id,token="eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiJ9..bAIydF671CMJJXTWCi9VmNM5-LqQMb1Q-OrBmR40_6y-JQEZqqE6-EAlGnmwXzcVS9X53Qawht7c_mmzfjzSK_7_fqdBSo6gSXVDyc9OmnsJd1rAFPDXx0xF-dQ27vVITbEn3KTD8sJhPQbLXtN6kxY6w7B2S82r-M3jPONMg9pdJHq83sOZi28KLm68uShEHO36XhIWxaxJPRamLmHfDhJWh9BRXZCORXvMYMNAG-r-onRa8E6MfOaTpTUHQPGFcPdyk3KVp31IeTAt2HwGbdjG72j953OxVyGcx5ximBWogrjgM8V8vXKtDZN4FDb5_J3C8DKmFRTQwPBNA7aKhg")
                ...
                if (nom_client and code_client) or code_client:
                    ...
                    clients = extract_clients_info('https://pp-unum-back.etcinfo.tech/api/societe/clients' , code_client ,token="eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiJ9..N_QeyVcsIimQyF8WeXEkF5KOBBZs_f4Csa8ARPxpOCBX5kvswkyjAbSy5-MGSDTessZD4CvU71Jx8MThlRnQTYnwFEJgxA_sYg7nXYesiP_bwOFaIW0QpcDNKdJTnpl6w1hcY2ln8HP8zh5sFLm3GHhprmyLjELRh88ms9GHTX9vMD0iupzIBhos4NvwDNoyxKQeOGhyUFj_k5YsBHWiSbs3QPPE2D-eqJeT6UI0lfFKV6AifUXNlFXxYTxCyljht3rFWTRYLWc7UjtDkGz6ZR13T8LBGNeu9zQLhWMsslJWpkCgNajqXL9NntKpfjmI9dU1tTCI8mUd_KZUPOKDpg")
                    ...
                    for client in clients:
                        for detected_type, detected_value in client.items():
                            ...
                            if detected_type =='idTier' :
                                 id_contact = extract_contact_info(detected_value, token="eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiJ9..N_QeyVcsIimQyF8WeXEkF5KOBBZs_f4Csa8ARPxpOCBX5kvswkyjAbSy5-MGSDTessZD4CvU71Jx8MThlRnQTYnwFEJgxA_sYg7nXYesiP_bwOFaIW0QpcDNKdJTnpl6w1hcY2ln8HP8zh5sFLm3GHhprmyLjELRh88ms9GHTX9vMD0iupzIBhos4NvwDNoyxKQeOGhyUFj_k5YsBHWiSbs3QPPE2D-eqJeT6UI0lfFKV6AifUXNlFXxYTxCyljht3rFWTRYLWc7UjtDkGz6ZR13T8LBGNeu9zQLhWMsslJWpkCgNajqXL9NntKpfjmI9dU1tTCI8mUd_KZUPOKDpg")
                    ...
                    pied = extract_total_amount( "https://pp-unum-back.etcinfo.tech/api/societe/piece/total-amount",payload,token ="eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiJ9..bAIydF671CMJJXTWCi9VmNM5-LqQMb1Q-OrBmR40_6y-JQEZqqE6-EAlGnmwXzcVS9X53Qawht7c_mmzfjzSK_7_fqdBSo6gSXVDyc9OmnsJd1rAFPDXx0xF-dQ27vVITbEn3KTD8sJhPQbLXtN6kxY6w7B2S82r-M3jPONMg9pdJHq83sOZi28KLm68uShEHO36XhIWxaxJPRamLmHfDhJWh9BRXZCORXvMYMNAG-r-onRa8E6MfOaTpTUHQPGFcPdyk3KVp31IeTAt2HwGbdjG72j953OxVyGcx5ximBWogrjgM8V8vXKtDZN4FDb5_J3C8DKmFRTQwPBNA7aKhg")
                    print("pied",pied)
        ...
        for ligne in facture_data['lignes']:
                ...
                etat =check_stock(article_id, quantity, api_url="https://pp-unum-back.etcinfo.tech/api/societe/piece/article-quantites", token="eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiJ9..bAIydF671CMJJXTWCi9VmNM5-LqQMb1Q-OrBmR40_6y-JQEZqqE6-EAlGnmwXzcVS9X53Qawht7c_mmzfjzSK_7_fqdBSo6gSXVDyc9OmnsJd1rAFPDXx0xF-dQ27vVITbEn3KTD8sJhPQbLXtN6kxY6w7B2S82r-M3jPONMg9pdJHq83sOZi28KLm68uShEHO36XhIWxaxJPRamLmHfDhJWh9BRXZCORXvMYMNAG-r-onRa8E6MfOaTpTUHQPGFcPdyk3KVp31IeTAt2HwGbdjG72j953OxVyGcx5ximBWogrjgM8V8vXKtDZN4FDb5_J3C8DKmFRTQwPBNA7aKhg")
        ...
        if len (code_etat) >=1 :
                        ...
                        resultat = add_facture(facture_data, api_url="https://pp-unum-back.etcinfo.tech/api/societe/avoirs", static_token="eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiJ9..bAIydF671CMJJXTWCi9VmNM5-LqQMb1Q-OrBmR40_6y-JQEZqqE6-EAlGnmwXzcVS9X53Qawht7c_mmzfjzSK_7_fqdBSo6gSXVDyc9OmnsJd1rAFPDXx0xF-dQ27vVITbEn3KTD8sJhPQbLXtN6kxY6w7B2S82r-M3jPONMg9pdJHq83sOZi28KLm68uShEHO36XhIWxaxJPRamLmHfDhJWh9BRXZCORXvMYMNAG-r-onRa8E6MfOaTpTUHQPGFcPdyk3KVp31IeTAt2HwGbdjG72j953OxVyGcx5ximBWogrjgM8V8vXKtDZN4FDb5_J3C8DKmFRTQwPBNA7aKhg")
                        articles.clear()
                        facture_data['lignes'].clear()
                        if resultat:
                                    response = {
